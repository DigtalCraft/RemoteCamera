namespace RemoteCamera
{
    partial class frmRemoteCamera
    {
        ...
        private ComboBox networkCameraComboBox = null!;
        private Button buttonApplyCamera = null!;
        private Button buttonApplyNetworkCamera = null!;
        private Button buttonRefreshDevices = null!;
        private Button buttonNetworkCameraMaster = null!;
        ...
        private void InitializeComponent()
        {
            ...
            networkCameraComboBox = new ComboBox();
            buttonApplyCamera = new Button();
            buttonApplyNetworkCamera = new Button();
            buttonRefreshDevices = new Button();
            buttonNetworkCameraMaster = new Button();
            ...
            // 
            // networkCameraComboBox
            // 
            networkCameraComboBox.DropDownStyle = ComboBoxStyle.DropDownList;
            networkCameraComboBox.FormattingEnabled = true;
            networkCameraComboBox.Location = new Point(278, 11);
            networkCameraComboBox.Margin = new Padding(3, 7, 10, 3);
            networkCameraComboBox.Name = "networkCameraComboBox";
            networkCameraComboBox.Size = new Size(280, 23);
            networkCameraComboBox.TabIndex = 1;
            // 
            // buttonApplyCamera
            // 
            ...
            // 
            buttonApplyNetworkCamera.AutoSize = true;
            buttonApplyNetworkCamera.FlatAppearance.BorderSize = 1;
            buttonApplyNetworkCamera.FlatStyle = FlatStyle.Flat;
            buttonApplyNetworkCamera.Location = new Point(704, 7);
            buttonApplyNetworkCamera.Margin = new Padding(3, 3, 10, 3);
            buttonApplyNetworkCamera.MinimumSize = new Size(144, 42);
            buttonApplyNetworkCamera.Name = "buttonApplyNetworkCamera";
            buttonApplyNetworkCamera.Padding = new Padding(12, 0, 12, 0);
            buttonApplyNetworkCamera.Size = new Size(144, 42);
            buttonApplyNetworkCamera.TabIndex = 3;
            buttonApplyNetworkCamera.Text = "ネットワーク反映";
            buttonApplyNetworkCamera.UseVisualStyleBackColor = false;
            // 
            ...
            // 
            // buttonNetworkCameraMaster
            // 
            buttonNetworkCameraMaster.AutoSize = true;
            buttonNetworkCameraMaster.FlatAppearance.BorderSize = 1;
            buttonNetworkCameraMaster.FlatStyle = FlatStyle.Flat;
            buttonNetworkCameraMaster.Location = new Point(966, 7);
            buttonNetworkCameraMaster.Margin = new Padding(3, 3, 10, 3);
            buttonNetworkCameraMaster.MinimumSize = new Size(150, 42);
            buttonNetworkCameraMaster.Name = "buttonNetworkCameraMaster";
            buttonNetworkCameraMaster.Padding = new Padding(12, 0, 12, 0);
            buttonNetworkCameraMaster.Size = new Size(150, 42);
            buttonNetworkCameraMaster.TabIndex = 5;
            buttonNetworkCameraMaster.Text = "ネットワーク設定";
            buttonNetworkCameraMaster.UseVisualStyleBackColor = false;
            // 
            // buttonSelectPath
            // 
