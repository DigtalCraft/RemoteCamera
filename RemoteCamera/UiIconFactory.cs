...
namespace RemoteCamera
{
    ...
    internal static class UiIconFactory
    {
        ...
        /// 設定画面用のアイコンを作成する。
        /// </summary>
        /// <returns>設定画面のタイトルバーで使うアイコン。</returns>
        public static Icon CreateSettingsIcon()
        {
            using var bitmap = CreateButtonBitmap(ButtonIconKind.Settings);
            return BitmapToIcon(bitmap);
        }
        ...
        /// 設定アイコンを描画する。
        /// </summary>
        private static void DrawSettingsIcon(Graphics graphics)
        {
            using var gearOuterBrush = new SolidBrush(Color.FromArgb(255, 120, 200, 255));
            using var gearInnerBrush = new SolidBrush(Color.FromArgb(255, 26, 42, 66));
            using var centerBrush = new SolidBrush(Color.FromArgb(255, 212, 235, 255));
            using var highlightBrush = new SolidBrush(Color.FromArgb(255, 255, 255, 255));

            graphics.FillEllipse(gearOuterBrush, 3, 3, 18, 18);

            var teeth = new[]
            {
                new Point[] { new(11, 1), new(13, 1), new(14, 4), new(10, 4) },
                new Point[] { new(19, 11), new(23, 10), new(23, 13), new(19, 14) },
                new Point[] { new(11, 23), new(13, 23), new(14, 20), new(10, 20) },
                new Point[] { new(1, 11), new(5, 10), new(5, 14), new(1, 13) },
                new Point[] { new(18, 4), new(21, 2), new(22, 5), new(19, 7) },
                new Point[] { new(18, 20), new(19, 17), new(22, 19), new(21, 22) },
                new Point[] { new(4, 4), new(7, 7), new(5, 10), new(2, 7) },
                new Point[] { new(4, 20), new(2, 17), new(5, 14), new(7, 17) }
            };

            using var teethBrush = new SolidBrush(Color.FromArgb(255, 78, 158, 236));
            foreach (var tooth in teeth)
            {
                graphics.FillPolygon(teethBrush, tooth);
            }

            graphics.FillEllipse(gearInnerBrush, 7, 7, 10, 10);
            graphics.FillEllipse(centerBrush, 10, 10, 4, 4);
            graphics.FillEllipse(highlightBrush, 8, 8, 3, 3);
        }
